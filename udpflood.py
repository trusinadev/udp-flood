...
Created by Legacy -> https://github.com/trusinadev/udp-flood
Usage : python3 udpflood.py
...
print("\033[1;34;40m \n")
os.system("figlet DDOS ATTACK V1.0 -f slant")

print("\033[1;32;40m ==> Code by Legacy <==  \n")
test = input()
if test == "n":
	exit(0)
